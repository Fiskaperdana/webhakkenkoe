...
<div class="boxform">
<a href="#form-box" class="form-window namatambah"><img src="images/3.jpg" width="150" height="150" />Nama Produk</a></div>
<div id="form-box" class="form-popup"  align="center">
      <form method="post" class="add" action="cart.php">
<fieldset class="textbox">
        	<label>
            <span>ID Kategori :</span>
            <select name='nama_ktgproduk' size='1' multiple='MULTIPLE' >
            <?php
			$sql="SELECT * from ktgproduk ORDER BY nama_ktgproduk ASC";
			$tampil=mysql_query($sql);
			
			while($r=mysql_fetch_array($tampil)){
				echo"<option style='text-align:center' value=$r[id_ktgproduk]>$r[nama_ktgproduk]</option>";
			}
			?></select></label>
        	<label>
            ...
            <input id="hrg_satuan" type="text" name="hrg_satuan" value="Rp 0,-"/>
            </label>
            <label>
            <span>Harga Per Lusin :</span>
            <input id="hrg_lusin"  type="text" name="hrg_lusin" value="Rp 0,-"/>
        	</label>
