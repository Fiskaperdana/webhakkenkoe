...
<div align="center">
            <table id="datatables" class="display">
                ...
                <tbody>
                    <?php
					          $sql = mysql_query("SELECT * FROM ktgproduk ORDER BY id_ktgproduk");
					          $no = 1;
                    while ($r = mysql_fetch_array($sql)) {
                      echo "<tr>
                            <td width=40>$no</td>
                            <td>$r[nama_ktgproduk]</td>
							<td><a href='edit_kategori.php?=$r[nama_ktgproduk]' name='edit'>Edit</a></td>
							<td><a href='javascrip:confirmdelete('hapus_kategori.php?=$r[nama_ktgproduk]')'>Hapus</td>
                            </tr>";
                      $no++;
                    }                    
                    ?>
